    ...
    <div className="guest-modal">
      <div className="guest-modal-options">
        ...
        <div className="guest-modal-options-right">
          <button className={`guest-modal-options-right-mbtn ${isButtonDisabled ? "disabled" : ""}`} onClick={() => decrement("adults")} disabled={adults === 0}>
            <svg
              viewBox="0 0 12 12"
      ...
      <div className="guest-modal-options">
        ...
        <div className="guest-modal-options-right">
          <button className={`guest-modal-options-right-mbtn ${isButtonDisabled ? "disabled" : ""}`} onClick={() => decrement("children")} disabled={children === 0}>
            <svg
              viewBox="0 0 12 12"
              xmlns="http://www.w3.org/2000/svg"
              aria-hidden="true"
      ...
      <div className="guest-modal-options">
        ...
        <div className="guest-modal-options-right">
          <button className={`guest-modal-options-right-mbtn ${isButtonDisabled ? "disabled" : ""}`} onClick={() => decrement("infants")} disabled={infants === 0}>
            <svg
              viewBox="0 0 12 12"
              xmlns="http://www.w3.org/2000/svg"
              aria-hidden="true"
