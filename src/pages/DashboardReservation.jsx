    ...
    datasets: [
      {
        ...
        backgroundColor: ['#1E90FF', '#000000', '#32CD32', '#FFD700', '#8A2BE2'],
        hoverBackgroundColor: ['#1E90FF', '#000000', '#32CD32', '#FFD700', '#8A2BE2'],
      },
    ],
  }
            ...
            <tr key={order._id}>
              ...
              <td>
                <div className="action-btns">
                  <button className="approve-btn" onClick={() => handleStatusChange(order._id, 'approved')}>Approve</button>
                  <button className="reject-btn" onClick={() => handleStatusChange(order._id, 'rejected')}>Reject</button>
                </div>
              </td>
            </tr>
          ))}
